 ...
 */
function front_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['front_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('front sample setting'),
  '#default_value' => theme_get_setting('front_example'),
